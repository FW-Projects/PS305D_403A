...
#define NTC_ADC_PIN    GPIO_PINS_0
...
#define ADC_V_PIN    GPIO_PINS_7
#define ADC_V_GPIO_PORT    GPIOA
#define TYPEC_A_PIN    GPIO_PINS_4
#define TYPEC_A_GPIO_PORT    GPIOC
#define TYPEC_V_PIN    GPIO_PINS_5
#define TYPEC_V_GPIO_PORT    GPIOC
#define USBA_A_PIN    GPIO_PINS_0
#define USBA_A_GPIO_PORT    GPIOB
#define USBA_V_PIN    GPIO_PINS_1
#define USBA_V_GPIO_PORT    GPIOB
