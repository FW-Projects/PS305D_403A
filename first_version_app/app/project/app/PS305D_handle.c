...
void PS305D_init(PS305D_t *fwps305d)
{
	...
	fwps305d->system_parameters.mod1_set_current_data = 5000;
	fwps305d->system_parameters.mod2_set_current_data = 5000;
	fwps305d->system_parameters.mod3_set_current_data = 5000;
	fwps305d->system_parameters.mod4_set_current_data = 5000;
	fwps305d->system_parameters.mod1_set_voltage_data = 450;
	fwps305d->system_parameters.mod2_set_voltage_data = 450;
	fwps305d->system_parameters.mod3_set_voltage_data = 450;
	fwps305d->system_parameters.mod4_set_voltage_data = 450;
